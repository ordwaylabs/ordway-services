...
Introducing a generic service design pattern which will help us to have centralized business logic in our application, which thus avoids code duplication and adds better error handling.
